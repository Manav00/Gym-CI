                  ...
                  <br>
                   <div class="row">
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-2">
                        <div class="form-group bmd-form-group">
                          <input value="0" type="text" onchange="updateSubtotal()" id="mem_discount_price" name="mem_discount_price" class="form-control">Rs.
                      ...
                      <div class="col-sm-2">
                        <div class="form-group bmd-form-group">
                          <input type="text" id="mem_subtotal_price" name="mem_subtotal_price" class="form-control"  value="0">Rs.
                      ...
                      <div class="col-sm-2">
                        <div class="form-group bmd-form-group">
                          <input value="0" type="text" id="mem_grand_total" name="mem_grand_total" class="form-control" readonly>Rs.
                     ...
                     <div class="row">
                      ...
                      <div class="col-sm-2">
                        <div class="form-group bmd-form-group">
                          <input type="text" id="mem_amount_pay" name="mem_amount_pay" onchange="calculateRem()" class="form-control">Rs.
                      ...
                      <div class="col-sm-2">
                        <div class="form-group bmd-form-group">
                          <input type="text" id="mem_remain_price" name="mem_remain_price" class="form-control">Rs.
